...
export function RequisitionForm({ posiciones, personas }: { posiciones: Posicion[]; personas: Persona[] }) {
  ...
  async function enviar(event: FormEvent<HTMLFormElement>) {
    event.preventDefault(); setMensaje(null); setEnviando(true);
